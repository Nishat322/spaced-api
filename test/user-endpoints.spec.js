    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'disegnare', translation: 'draw'},
            { original: 'bere', translation: 'drink' },
            { original: 'guidare', translation: 'drive' },
            { original: 'mangiare', translation: 'eat' },
            { original: 'cadere', translation: 'fall' },
            { original: 'rempire', translation: 'fill' },
            { original: 'trovare', translation: 'find' },
            { original: 'finire', translation: 'finish' },
          ]
        }
